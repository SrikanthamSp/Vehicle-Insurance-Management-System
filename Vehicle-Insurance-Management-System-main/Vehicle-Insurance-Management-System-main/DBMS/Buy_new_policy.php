...
if(isset($_SESSION["Email_Address"]))
{
  ...
  $user2_query="select * from buy_policy";
     $rr1= mysqli_query($conn,$user1_query);
     $rr = mysqli_query($conn,$user_query);
     $rr3 = mysqli_query($conn,$user2_query);
     ...
     <form action="" method="post">
          ...
          <div class="input_field">
               ...
               <div class="custom_select">
                    <select name="Policy_Type" required><option value="" >Select</option>
                    <?php
          ...
          <div class="input_field">
               ...
               <input type="text" class="input" name="Email_Address" value="<?php echo $user_data["Email_Address"];?>">
          </div>
          <div class="input_field">
               <label>Customer Name</label>
               <input type="text" class="input" value="<?php echo $user_data["First_Name"]." ".$user_data["Last_Name"];?>" name="Customer_Name">
          </div>
          <div class="input_field">
        ...
        <div class="input_field">
         ...
         <div class="input_field">
              ...
              <input type="submit" class="btn" value="Pay" name="Payment" >  
               
              <a class="btn" href="CustomerDash1.php"  >  Cancel </a> 
